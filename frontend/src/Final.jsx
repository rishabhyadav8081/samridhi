  ...
  return (
    <section className="py-12 md:py-16 px-4 bg-linear-to-b from-[#D88C8C] to-[#D88C8C]  relative overflow-hidden ">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="bg-white/15 backdrop-blur-md rounded-[3rem] p-5 md:p-14 mb-10 border border-white/20 shadow-2xl">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/15 shadow-2xl max-w-3xl mx-auto">
          <i className="text-white  text-sm italic leading-relaxed mb-4">
          ...
          <p className=" text-xs font-semibold mt-5">—  Samridh Agarwal, Founder of Peach It Up</p>
        </div>
      </div>
    </section>
  );
